...
#    drive    : رابط درايف
#
#  كل مادة عندها في الآخر:
#    audio      : رابط قروب تيليغرام الصوت
#    video_prof : رابط فيديو الأستاذ
#    resume     : رابط الملخص
# ================================================================
...
UEI03_links = {
    "Anatomie": {
        "_module": module_links(
            audio      = None,  # https://t.me/c/...
            video_prof = None,  # https://t.me/c/...
            resume     = None,  # https://drive.google.com/...
        ),
...
UEI05_links = {
    "Anatomie": {
        ...
        "ostéologie du crane":                     cours(youtube=None, drive=None),
        "ostéologie de la face 2":                 cours(youtube=None, drive=None),
        "ARTICULATION TEMPORO-MANDIBULAIRE (ATM)": cours(youtube=None, drive=None),
        "Morphologie de la moelle épinière":       cours(youtube=None, drive=None),
        "Cervelet et méninges":                    cours(youtube=None, drive=None),
        "TRONC CÉRÉBRAL":                          cours(youtube=None, drive=None),
        "Diencéphale":                             cours(youtube=None, drive=None),
        "CONFIGURATION INTERNE":                   cours(youtube=None, drive=None),
        "morphologie du télencéphale":             cours(youtube=None, drive=None),
        "vascularisation du cerveau":              cours(youtube=None, drive=None),
        "oreille":                                 cours(youtube=None, drive=None),
        "oeil et cavité orbitaire":                cours(youtube=None, drive=None),
    },
    "Biophysique": {
        "_module": module_links(audio=None, video_prof=None, resume=None),
